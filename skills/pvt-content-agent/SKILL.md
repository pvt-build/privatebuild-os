---
name: pvt-content-agent
description: >-
  Área 04 de Private Build OS: que lo que publicas traiga a la persona que sí compra y
  filtre a la que no. Construye la cadena de 7 tramos del contenido (materia prima,
  insight, gancho, pieza, petición, señal, vuelta), decide qué publicar esta semana
  según el dolor de tu avatar y lo que ya rindió, audita primeras líneas, saca piezas de
  un transcript y cierra el loop con un Veredicto Repetir, Ajustar o Matar en Notion.
  Úsala cuando digas "qué publico esta semana", "arma mi mix de contenido", "audita
  estos ganchos", "dame primeras líneas para esto", "te pego la llamada, sácale piezas",
  "cierra el loop de lo que publiqué", "mi contenido no trae clientes", "diagnostica mi
  contenido". No define a quién le hablas (pvt-avatar-agent), no arma la oferta ni el
  recurso que pides al final (pvt-offer-agent), no responde ni califica los mensajes que
  llegan (pvt-setter-agent) y no decide la piel visual de tu marca.
---
