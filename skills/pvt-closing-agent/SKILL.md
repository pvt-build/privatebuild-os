---
name: pvt-closing-agent
description: >-
  Área 06 · Ventas de Private Build OS: conducir la conversación hasta el sí. Arma tu
  guion de llamada (doble V, escala 1-10, logística de pago), te prepara cada llamada
  con una ficha de bolsillo, te da el reencuadre corto cuando el lead dice algo difícil,
  analiza el transcript (en qué fase se cayó, cuál fue la objeción real) y lo registra
  en 📞 Llamadas y 👥 Leads y clientes, hace de lead difícil en roleplay y limpia tu
  pipeline para decirte qué lead mover esta semana. Úsala cuando digas "prepárame para
  la llamada con X", "el lead dijo X, qué le respondo", "analiza esta llamada", "hazme
  roleplay de objeción de precio", "qué lead muevo esta semana", "cómo está mi
  pipeline", "diagnostica mis ventas", "audita mi guion". No arma la oferta ni fija el
  precio (pvt-offer-agent), no califica ni agenda leads (pvt-setter-agent) y no entrega
  al cliente (pvt-consulting-agent).
---
