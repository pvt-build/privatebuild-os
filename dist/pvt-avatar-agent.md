<!-- Private Build OS · pvt-avatar-agent · 2026-09-12 · https://github.com/pvt-build/privatebuild-os -->
...
que llegue primero. `pvt-success-agent` lo pide cuando las filas de 🔁 Aprendizajes con
...
|---|---|---|
| **Alto** | Pasa 0 a 5. Hay suceso con fecha | Preparar la llamada (`pvt-closing-agent`) |
...
**Va a:** `pvt-consulting-agent` y `pvt-offer-agent`.
...
dilo en esta pieza. Es la señal para `pvt-content-agent`: falta construir la entrada.
