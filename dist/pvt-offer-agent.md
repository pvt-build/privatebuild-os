<!-- Private Build OS · pvt-offer-agent · 2026-09-12 · https://github.com/pvt-build/privatebuild-os -->
...
precio, capacidad o formato, pasa por `pvt-founder-agent` (8 criterios en
⚖️ Decisiones) antes de aplicarlo.
...
`pvt-success-agent` procesa esas filas; cada skill hermana las lee al abrir su área.
...
- **Fuente:** el perfil y el anti-perfil viven en 03 · Avatar. Si no están,
  handoff a `pvt-avatar-agent`; acá solo se escribe la frase que filtra.
...
Esa decisión va a `pvt-founder-agent`.
...
- La llamada de cierre se agenda con los dos. Eso lo ejecuta `pvt-closing-agent`.
...
Dos recordatorios para `pvt-closing-agent`:
